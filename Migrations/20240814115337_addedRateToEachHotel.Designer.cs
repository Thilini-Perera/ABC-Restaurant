...
namespace ABCResturant.Migrations
{
    ...
    [Migration("20240814115337_addedRateToEachHotel")]
    partial class addedRateToEachHotel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABCResturant.Models.ChatRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABCResturant.Models.RestuarantReservation", b =>
                {
                    b.Property<int>("RestuarantId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RestuarantId", "ReservationId");

                    b.HasIndex("ReservationId");

                    b.ToTable("RestuarantReservations");
                });
            ...
            modelBuilder.Entity("ABCResturant.Models.UserActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ABCResturant.Models.CustomerResponse", b =>
                {
                    b.HasOne("ABCResturant.Models.ChatRoom", "ChatRoom")
                        .WithMany("CustomerResponses")
            ...
            modelBuilder.Entity("ABCResturant.Models.RestuarantReservation", b =>
                {
                    b.HasOne("ABCResturant.Models.Reservation", "Reservation")
                        .WithMany("RestuarantReservations")
            ...
            modelBuilder.Entity("ABCResturant.Models.ChatRoom", b =>
                {
                    b.Navigation("CustomerResponses");
                });

            modelBuilder.Entity("ABCResturant.Models.Reservation", b =>
                {
                    b.Navigation("RestuarantReservations");
                });
